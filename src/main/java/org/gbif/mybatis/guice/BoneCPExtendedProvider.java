...
/**
 * Provides the BoneCP DataSource with extended configuration options.
 * This is a modified copy of the original org.mybatis.guice.datasource.bonecp.BoneCPProvider class
 * that is declared as final and thus cannot be subclassed.
 *
 * Added options are:
 * <ul>
 *   <li>bonecp.defaultReadOnly</li>
 *   <li>bonecp.defaultAutoCommit</li>
 *   <li>bonecp.statisticsEnabled</li>
 * </ul>
 */
public final class BoneCPExtendedProvider implements Provider<DataSource> {
    ...
    // EXTENDED GBIF CLASS CONFIGURATIONS
    @com.google.inject.Inject(optional = true)
    public void setDefaultReadOnly(@Named("bonecp.defaultReadOnly") boolean defaultReadOnly) {
        dataSource.setDefaultReadOnly(defaultReadOnly);
    }

    @com.google.inject.Inject(optional = true)
    public void setDefaultAutoCommit(@Named("bonecp.defaultAutoCommit") boolean defaultAutoCommit) {
        dataSource.setDefaultAutoCommit(defaultAutoCommit);
    }

    @com.google.inject.Inject(optional = true)
    public void setStatisticsEnabled(@Named("bonecp.statisticsEnabled") boolean statisticsEnabled) {
        dataSource.setStatisticsEnabled(statisticsEnabled);
    }
}
